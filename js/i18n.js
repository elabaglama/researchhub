...
const T = {
  it: {
    ...
    "lib.shareCopied":     "Link copiato! È sempre lo stesso — si aggiorna quando condividi di nuovo.",
    ...
    "filter.anyDate":      "Qualsiasi data",
    "filter.today":        "Oggi",
    "filter.tomorrow":     "Domani",
    "filter.thisWeek":     "Questa settimana",
    "filter.nextMonth":    "Prossimo mese",
    // daily
    ...
    // guide
    "guide.step1.title": "Stai cercando in diversi siti per trovare opportunità?",
    "guide.step1.body":  "Inizia ad aggiungere alla libreria i tuoi link salvati a siti di bandi aperti, risorse e gruppi pubblici di Facebook e LinkedIn che segui.",
  ...
  en: {
    ...
    "lib.shareCopied":     "Link copied! It's always the same — it updates when you share again.",
    ...
    "guide.step1.title": "Are you searching different sites to find opportunities?",
    "guide.step1.body":  "Start adding to your library the saved links to open-call sites, resources, and public Facebook and LinkedIn groups you follow.",
